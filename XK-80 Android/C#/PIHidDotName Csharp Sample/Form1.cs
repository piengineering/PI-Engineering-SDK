    ...
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
            ...
            else
            {
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    if (devices[i].HidUsagePage == 0xc && devices[i].WriteLength==36)
                    {
                        ...
                        {
                            case 1217:
                                CboDevices.Items.Add("XK-80 Android (" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1218:
                                CboDevices.Items.Add("XK-80 Android (" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1219:
                                CboDevices.Items.Add("XK-80 Android (" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1220:
                                CboDevices.Items.Add("XK-80 Android (" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1231:
                                CboDevices.Items.Add("XK-60 Android (" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1232:
                                CboDevices.Items.Add("XK-60 Android (" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1233:
                                CboDevices.Items.Add("XK-60 Android (" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1234:
                                CboDevices.Items.Add("XK-60 Android (" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            default:
        ...
        private void BtnBL_Click(object sender, EventArgs e)
        {
            ...
            if (CboDevices.SelectedIndex != -1) //do nothing if not enumerated
            {
                ...
                wData[0] = 0;
                wData[1] = 187;
                wData[2] = 128; //0-255 for brightness of bank 1 bl leds
                wData[3] = 128; //0-255 for brightness of bank 2 bl leds
