    ...
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
        ...
        public void HandlePIEHidData(Byte[] data, PIEDevice sourceDevice, int error)
        {
            ...
            if (sourceDevice == devices[selecteddevice])
            {
                ...
                if (data[2] < 4)
                {
                    ...
                    int maxrows = 8; //number of rows of Xkeys digital button data
                    c = this.LblButtons;
                    ...
                    for (int i = 0; i < maxcols; i++) //loop through digital button bytes 
                    {
                        for (int j = 0; j < maxrows; j++) //loop through each bit in the button byte
                        {
                            ...
                            int keynum = maxrows * i + j; //using key numbering in sdk; column 1 = 0,1,2... column 2 = 8,9,10... etc
            ...
            else
            {
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        else if (devices[i].Pid == 1621 || devices[i].Pid == 1629 || devices[i].Pid == 1637)
                        {
        ...
        private void ChkBank1OnOff_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (selecteddevice != -1) //do nothing if not enumerated
            {
                ...
                wData[0] = 0;
                wData[1] = 182; //0xb6
                wData[2] = 0;  //0 for Bank 1 Blue LEDs
        ...
        {
            //Request the state of the desired RGB LED, returns states for bank 1
            if (selecteddevice != -1) //do nothing if not enumerated
            {
        ...
        {
            //Set Green Indicator LED status
            if (selecteddevice != -1)
            {
                ...
                {
                    toolStripStatusLabel1.Text = "Write Success - Set Green Indicator LED";
                }
            }
        }

        private void chkLED2_CheckStateChanged(object sender, EventArgs e)
        {
            //Set Red Indicator LED status
            if (selecteddevice != -1)
            {
                CheckBox thischkbox = (CheckBox)sender;
                byte ledindex = Convert.ToByte(thischkbox.Tag.ToString());
                ...
                {
                    toolStripStatusLabel1.Text = "Write Success - Set Red Indicator LED";
                }
            }
        }
