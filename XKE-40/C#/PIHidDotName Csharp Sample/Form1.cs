        ...
        public void HandlePIEHidData(Byte[] data, PIEDevice sourceDevice, int error)
        {
            ...
            if (sourceDevice == devices[selecteddevice])
            {
                ...
                else if (data[2] == 0xae) //backlight states
                {
                    ...
                    //bank 1
                    for (int i = 5; i < 10; i++) //each byte (column)
                    {
                    ...
                    //bank 2
                    for (int i = 10; i < 15; i++) //each byte (column)
                    {
                        for (int j = 0; j < 8; j++) //each bit in the byte represents an led
                        {
                            int temp1 = (int)Math.Pow(2, j);
                ...
                else if (data[2] == 0xaf)
                {
                    ...
                    //Bank 1
                    for (int i = 5; i < 10; i++) //bank 1 leds, each byte
                    {
                    ...
                    //Bank 2
                    for (int i = 10; i < 15; i++) //bank 2 leds, each byte
                    {
                        for (int j = 0; j < 8; j++) //each bit in the byte
                        {
                            int temp1 = (int)Math.Pow(2, j);
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        else if (devices[i].Pid == 1362)
                        {
                            ...
                            CboDevices.Items.Add("XKE-40 Stick for KVM (" + devices[i].Pid + "=PID #8), ID: " + i);
                            cbotodevice[cbocount] = i;
                            cbocount++;
