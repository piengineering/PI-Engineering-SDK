...
namespace PIHidDotName_Csharp_Sample
{
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
        ...
        private void DisableAllControls(int thispid)
        {
            ...
            if (thispid == 1403)
                MessageBox.Show("Device in KVM PID, no input or output reports are available. To exit KVM mode unplug device and replug it, immediately toggle the Scroll Lock key several times.");
