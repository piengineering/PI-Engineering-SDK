            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                If devices(i).HidUsagePage = 12 And devices(i).WriteLength = 36 Then
                    ...
                    Select Case devices(i).Pid
                        Case 1196
                            CboDevices.Items.Add("Matrix Encoder Board Android (" + devices(i).Pid.ToString + "=PID #1): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1197
                            CboDevices.Items.Add("Matrix Encoder Board Android (" + devices(i).Pid.ToString + "=PID #2): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1198
                            CboDevices.Items.Add("Matrix Encoder Board Android (" + devices(i).Pid.ToString + "=PID #3): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1199
                            CboDevices.Items.Add("Matrix Encoder Board Android (" + devices(i).Pid.ToString + "=PID #4): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1200
                            CboDevices.Items.Add("XK-3 Foot Pedal Android (" + devices(i).Pid.ToString + "=PID #1): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1201
                            CboDevices.Items.Add("XK-3 Foot Pedal Android (" + devices(i).Pid.ToString + "=PID #2): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1202
                            CboDevices.Items.Add("XK-3 Foot Pedal Android  (" + devices(i).Pid.ToString + "=PID #3): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1203
                            CboDevices.Items.Add("XK-3 Foot Pedal Android  (" + devices(i).Pid.ToString + "=PID #4): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case Else
