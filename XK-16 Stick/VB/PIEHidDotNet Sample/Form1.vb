...
Public Class Form1
            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                If devices(i).HidUsagePage = 12 And devices(i).WriteLength = 36 Then
                    ...
                    Select Case devices(i).Pid
                        Case 1049
                            CboDevices.Items.Add("XK-16 Stick (" + devices(i).Pid.ToString + "=PID #1): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1050
                            CboDevices.Items.Add("XK-16 Stick (" + devices(i).Pid.ToString + "=PID #2): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1051
                            CboDevices.Items.Add("XK-16 Stick (" + devices(i).Pid.ToString + "=PID #3): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1251
                            CboDevices.Items.Add("XK-16 Stick (" + devices(i).Pid.ToString + "=PID #4): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1127
                            CboDevices.Items.Add("XK-4 Stick (" + devices(i).Pid.ToString + "=PID #1): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1128
                            CboDevices.Items.Add("XK-4 Stick (" + devices(i).Pid.ToString + "=PID #2): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1129
                            CboDevices.Items.Add("XK-4 Stick (" + devices(i).Pid.ToString + "=PID #3): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1253
                            CboDevices.Items.Add("XK-4 Stick (" + devices(i).Pid.ToString + "=PID #4): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1130
                            CboDevices.Items.Add("XK-8 Stick (" + devices(i).Pid.ToString + "=PID #1): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1131
                            CboDevices.Items.Add("XK-8 Stick (" + devices(i).Pid.ToString + "=PID #2): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1132
                            CboDevices.Items.Add("XK-8 Stick (" + devices(i).Pid.ToString + "=PID #3): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1252
                            CboDevices.Items.Add("XK-8 Stick (" + devices(i).Pid.ToString + "=PID #4): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case Else
    ...
    Private Sub BtnMultiMedia_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMultiMedia.Click
        '//Multimedia available on v10 firmware or above.
    ...
    Private Sub BtnIncIntesity_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub BtnCheckDongle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCheckDongle.Click
        ...
        If CboDevices.SelectedIndex <> -1 Then
            ...
            Dim N0 As Integer = rnd.[Next](1, 254)
            'pick any number between 1 and 254, 0 and 255 not allowed
            Dim N1 As Integer = rnd.[Next](1, 254)
            'pick any number between 1 and 254, 0 and 255 not allowed
            Dim N2 As Integer = rnd.[Next](1, 254)
            'pick any number between 1 and 254, 0 and 255 not allowed
            Dim N3 As Integer = rnd.[Next](1, 254)
            'pick any number between 1 and 254, 0 and 255 not allowed
