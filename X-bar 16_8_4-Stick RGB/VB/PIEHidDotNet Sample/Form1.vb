...
Public Class Form1
            ...
            SetText(data(1).ToString)
                ...
                c = Me.LblButtons
                    ...
                    For i As Integer = 0 To maxcols - 1
                        ...
                        Dim keynum As Integer = maxrows * i + j 'column 1 = 0,1,2... column 2 = 8,9,10...  etc
        ...
        Else
            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                Else
                    ...
                    ElseIf (devices(i).Pid = 1621 Or devices(i).Pid = 1629 Or devices(i).Pid = 1637) Then
    ...
    Private Sub bState_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetBLState.Click
    ...
    Private Sub chkLED1_CheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkLED2.CheckStateChanged, chkLED1.CheckStateChanged
        If CboDevices.SelectedIndex <> -1 Then
