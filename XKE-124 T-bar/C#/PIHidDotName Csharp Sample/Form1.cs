    ...
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
        ...
        public void HandlePIEHidData(Byte[] data, PIEDevice sourceDevice, int error)
        {
            ...
            if (sourceDevice == devices[selecteddevice])
            {
                ...
                //T-bar data
                c = LblTbar;
                this.SetText("T-bar: "+BinToHex(data[29]));
            ...
            else
            {
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    if (devices[i].HidUsagePage == 0xc && devices[i].WriteLength==36)
                    {
                        ...
                        {
                            case 1275:
                                CboDevices.Items.Add("XKE-124 T-bar (" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1276:
                                CboDevices.Items.Add("XKE-124 T-bar (" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1277:
                                CboDevices.Items.Add("XKE-124 T-bar (" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1278:
                                CboDevices.Items.Add("XKE-124 T-bar (" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            default:
        ...
        private void BtnStartCal_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Mover T-bar slowly up and down to full extents.  When done click Stop Cal.");
        }
        ...
        private void ChkFlash_CheckedChanged_1(object sender, EventArgs e)
        {
            ChkGreen_CheckedChanged(this, null);
        }

        private void chkFlash2_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void ChkBLOnOff_CheckStateChanged(object sender, EventArgs e)
        {
            ...
            if (selecteddevice != -1)
            {
                ...
                //now get state
                int state = (byte) ChkBLOnOff.CheckState; //0=off, 1=0n, 2=flash
