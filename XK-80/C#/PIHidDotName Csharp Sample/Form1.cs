    ...
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
            ...
            else
            {
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    if (devices[i].HidUsagePage == 0xc && devices[i].WriteLength==36)
                    {
                        ...
                        {
                            case 1089:
                                CboDevices.Items.Add("XK-80 (" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1090:
                                CboDevices.Items.Add("XK-80 (" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1091:
                                CboDevices.Items.Add("XK-80 (" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1250:
                                CboDevices.Items.Add("XK-80 (" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1121:
                                CboDevices.Items.Add("XK-60 (" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1122:
                                CboDevices.Items.Add("XK-60 (" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1123:
                                CboDevices.Items.Add("XK-60 (" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1254:
                                CboDevices.Items.Add("XK-60 (" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            default:
        ...
        private void BtnDescriptor_Click(object sender, EventArgs e)
        {
            ...
            if (CboDevices.SelectedIndex != -1 && devices[selecteddevice].ReadLength>0)
            {
                ...
                listBox2.Items.Add("keymapstart msb=" + data[14].ToString());
        ...
        private void BtnBL_Click(object sender, EventArgs e)
        {
            ...
            if (selecteddevice != -1) //do nothing if not enumerated
            {
                ...
                wData[0] = 0;
                wData[1] = 187;
                wData[2] = 255; //0-255 for brightness of bank 1 bl leds
                wData[3] = 255; //0-255 for brightness of bank 2 bl leds
