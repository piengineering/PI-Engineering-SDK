...
Public Class Form1
            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                If devices(i).HidUsagePage = 12 And devices(i).WriteLength = 36 Then
                    ...
                    Select Case devices(i).Pid
                        Case 1089
                            CboDevices.Items.Add("XK-80 (" + devices(i).Pid.ToString + "=PID #1)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1090
                            CboDevices.Items.Add("XK-80 (" + devices(i).Pid.ToString + "=PID #2)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1091
                            CboDevices.Items.Add("XK-80 (" + devices(i).Pid.ToString + "=PID #3)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1250
                            CboDevices.Items.Add("XK-80 (" + devices(i).Pid.ToString + "=PID #4)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1121
                            CboDevices.Items.Add("XK-60 (" + devices(i).Pid.ToString + "=PID #1)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1122
                            CboDevices.Items.Add("XK-60 (" + devices(i).Pid.ToString + "=PID #2)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1123
                            CboDevices.Items.Add("XK-60 (" + devices(i).Pid.ToString + "=PID #3)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1254
                            CboDevices.Items.Add("XK-60 (" + devices(i).Pid.ToString + "=PID #4)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case Else
    ...
    Private Sub BtnMousereflect_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles BtnMousereflect.KeyPress
    ...
    Private Sub BtnMultiMedia_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMultiMedia.Click
        'Multimedia available on v5 firmware or above.
    ...
    Private Sub ChkBLOnOff_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkBLOnOff.CheckedChanged, ChkFlash2.CheckedChanged
