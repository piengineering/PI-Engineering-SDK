    ...
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
        ...
        private void BtnDescriptor_Click(object sender, EventArgs e)
        {
            ...
            if (selecteddevice != -1)
            {
                ...
                if (data[33] == 0)
                {
                    lblCurrentEnabled.Text = "game controller disabled";
                }
                else if (data[33] == 1)
                {
                    lblCurrentEnabled.Text = "game controller enabled";
                }
                listBox2.Items.Add("z axis or z rotation=" + data[34].ToString()); //0=z axis, 1=z rot
                if (data[34] == 0)
                {
                    lblCurrentTwist.Text = "z axis";
                }
                else if (data[34]==1)
                {
                    lblCurrentTwist.Text = "z rotation";
                }
                listBox2.Items.Add("unit rotation=" + data[22].ToString());
                cboUnitRotation.SelectedIndex = data[22];
