	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1192)
				{
					AddDevices(hDialog, "Found Device: XK-12 Switch Interface, PID=1192 (PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1193)
				{
					AddDevices(hDialog, "Found Device: XK-12 Switch Interface, PID=1193 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1194)
				{
					AddDevices(hDialog, "Found Device: XK-12 Switch Interface, PID=1194 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1195)
				{
					AddDevices(hDialog, "Found Device: XK-12 Switch Interface, PID=1195 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1221)
				{
					AddDevices(hDialog, "Found Device: XK-3 Switch Interface, PID=1221 (PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1222)
				{
					AddDevices(hDialog, "Found Device: XK-3 Switch Interface, PID=1222 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1223)
				{
					AddDevices(hDialog, "Found Device: XK-3 Switch Interface, PID=1223 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1224)
				{
					AddDevices(hDialog, "Found Device: XK-3 Switch Interface, PID=1224 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else
