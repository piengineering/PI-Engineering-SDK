...
namespace PIHidDotName_Csharp_Sample
{
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
        ...
        private void BtnEnumerate_Click(object sender, EventArgs e)
        {
            ...
            devices = PIEHid64Net.PIEDevice.EnumeratePIE();
            if (devices.Length == 0)
            {
            ...
            else
            {
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    int hidusagepg = (int)devices[i].HidUsagePage;
                    int hidusage = (int)devices[i].HidUsage;
                    ...
                    else
                    {
                        if (devices[i].Pid == 1292) //?? include this or not?
                        {
                            ...
                            cbotodevice[cbocount] = i;
                            cbocount++;
                            DisableAllControls((int)devices[i].Pid);
                        }
        ...
        private void chkLED1_CheckStateChanged(object sender, EventArgs e)
        {
            ...
            if (CboDevices.SelectedIndex != -1)
            {
                ...
                wData[1] = 179; //0xb3
                wData[2] = gpiopinindex; //1=Pin 1, 2=Pin 2, 3=Pin 3, 4=Pin 4
