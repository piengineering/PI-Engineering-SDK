Public Class Form1
            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                If devices(i).HidUsagePage = 12 And devices(i).WriteLength = 36 Then
                    ...
                    Select Case devices(i).Pid
                        Case 1279
                            CboDevices.Items.Add("XKR-32 Rack Mounted Keys (" + devices(i).Pid.ToString + "=PID #1)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1280
                            CboDevices.Items.Add("XKR-32 Rack Mounted Keys (" + devices(i).Pid.ToString + "=PID #2)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1281
                            CboDevices.Items.Add("XKR-32 Rack Mounted Keys (" + devices(i).Pid.ToString + "=PID #3)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1282
                            CboDevices.Items.Add("XKR-32 Rack Mounted Keys (" + devices(i).Pid.ToString + "=PID #4)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case Else
    ...
    Private Sub ChkFlash2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
