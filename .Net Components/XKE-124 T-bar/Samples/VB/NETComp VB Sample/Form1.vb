Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If (Xk124Tbar_1.ConnectedDevices.Length > 0) Then
                ...
                lblOEM.Text = "OEM Version ID: " & Xk124Tbar_1.ConnectedDevices(0).OEMVersion.ToString()

                'Gets the Product ID from the device
                lblProductID.Text = "Product ID: " & Xk124Tbar_1.ConnectedDevices(0).Pid.ToString()
            End If
    ...
    Private Sub btnJoystick_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnJoystick.Click
        ...
        If (Xk124Tbar_1.ConnectedDevices(0).JoystickInterface = True) Then
    ...
    Private Sub btnMouse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMouse.Click
        ...
        If (Xk124Tbar_1.ConnectedDevices(0).MouseInterface = True) Then
    ...
    Private Sub btnCheckDongle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCheckDongle.Click
        ...
        Dim dongle As Boolean = Xk124Tbar_1.GetSecurityKey(0, byte1, byte2, byte3, byte4)
    ...
    Private Sub btn1275_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn1275.Click
        'Changes device to the desired Product ID (device will "replug" itself)
    ...
    Private Sub Xk124Tbar_1_ButtonChange(ByVal e As XK_124Tbar.XKeyEventArgs) Handles Xk124Tbar_1.ButtonChange
    ...
    Private Sub Xk124Tbar_1_DevicePlug(ByVal e As XK_124Tbar.XKeyPlugEventArgs) Handles Xk124Tbar_1.DevicePlug
    ...
    Private Sub Xk124Tbar_1_DeviceUnplug(ByVal e As XK_124Tbar.XKeyPlugEventArgs) Handles Xk124Tbar_1.DeviceUnplug
    ...
    Private Sub Xk124Tbar_1_GenerateReportData(ByVal e As XK_124Tbar.XKeyEventArgs) Handles Xk124Tbar_1.GenerateReportData
        Xk124Tbar_1_ButtonChange(e)
    End Sub

    Private Sub Xk124Tbar_1_TbarChange(ByVal e As XK_124Tbar.XKeyTbarArgs) Handles Xk124Tbar_1.TbarChange
    ...
    Private Sub btnFrequency_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFrequency.Click
        ...
        Frequency = Convert.ToInt32(spnFrequency.Value)
