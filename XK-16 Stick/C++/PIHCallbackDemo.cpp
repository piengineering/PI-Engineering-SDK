	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1049)
				{
					AddDevices(hDialog, "Found Device: XK-16 Stick, PID=1049 (PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1050)
				{
					AddDevices(hDialog, "Found Device: XK-16 Stick, PID=1050 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1051)
				{
					AddDevices(hDialog, "Found Device: XK-16 Stick, PID=1051 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1251)
				{
					AddDevices(hDialog, "Found Device: XK-4 Stick, PID=1251 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1127)
				{
					AddDevices(hDialog, "Found Device: XK-4 Stick, PID=1127 (PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1128)
				{
					AddDevices(hDialog, "Found Device: XK-4 Stick, PID=1128 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1129)
				{
					AddDevices(hDialog, "Found Device: XK-4 Stick, PID=1129 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1253)
				{
					AddDevices(hDialog, "Found Device: XK-4 Stick, PID=1253 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1130)
				{
					AddDevices(hDialog, "Found Device: XK-8 Stick, PID=1127 (PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1131)
				{
					AddDevices(hDialog, "Found Device: XK-8 Stick, PID=1128 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1132)
				{
					AddDevices(hDialog, "Found Device: XK-8 Stick, PID=1129 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1252)
				{
					AddDevices(hDialog, "Found Device: XK-8 Stick, PID=1253 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else
