...
Public Class Form1
    ...
    Public Sub HandlePIEHidData(ByVal data() As Byte, ByVal sourceDevice As PIEHid32Net.PIEDevice, ByVal perror As Integer) Implements PIEHid32Net.PIEDataHandler.HandlePIEHidData
        ...
        If sourceDevice.Pid = devices(selecteddevice).Pid Then
            ...
            'Buttons
            Dim maxrows As Integer = 8 'number of bytes in documentation, labelled keys
            Dim maxcols As Integer = 10 'number of bits, constant
            c = LblButtons
            Dim buttonsdown As String
            buttonsdown = "Buttons: "
            SetText(buttonsdown)
            For i As Integer = 0 To maxcols - 1 'loop through digital button bytes 
                For j As Integer = 0 To maxrows 'loop through each bit in the button byte
                    ...
                    Select Case state
                        ...
                        Case 26
                            ...
                            'Buttons 27-29 covered by joystick.
                        ...
                        Case 34
                            ...
                            'Buttons 35-37 covered by joystick.
                        ...
                        Case 42
                            ...
                            'Buttons 43-45 covered by joystick.
                        ...
                        Case 50
                            ...
                            'Buttons 51-53 covered by joystick.
            ...
            If data(13) And 4 Then
                kstate = kstate + "NumLk"
            End If
            If data(13) And 8 Then
                kstate = kstate + " CapsLk"
            End If
            If data(13) And 16 Then
                kstate = kstate + " ScrLk"
            End If
            ...
            'Joystick
            c = LblJoyX
            SetText("Joy X:" + data(15).ToString)
            c = LblJoyY
            SetText("Joy Y:" + data(16).ToString)
            c = LblJoyZ
            SetText("Joy Z:" + data(17).ToString)
            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                If devices(i).HidUsagePage = 12 Then
                    ...
                    Select Case devices(i).Pid
                        Case 1117
                            CboDevices.Items.Add("XK-68 Joystick (" + devices(i).Pid.ToString + "=PID #1): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1118
                            CboDevices.Items.Add("XK-68 Joystick (" + devices(i).Pid.ToString + "): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case 1119
                            CboDevices.Items.Add("XK-68 Joystick (" + devices(i).Pid.ToString + "=PID #2): " + i.ToString)
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                        Case Else
