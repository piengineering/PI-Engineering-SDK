...
{
    //The following is a sample showing how to interact with an XKE-128 device using the X-keys XKE-128 .NET component.
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (xk128_1.ConnectedDevices == null)
            {
            ...
            else
            {
                ...
                lblUID.Text = "Unit ID: " + xk128_1.ConnectedDevices[0].UnitID;

                //Gets the OEM Version ID from the device
                lblOEM.Text = "OEM ID: " + xk128_1.ConnectedDevices[0].OEMVersion;

                //Gets the Product ID from the device
                lblProductID.Text = "Product ID: " + xk128_1.ConnectedDevices[0].Pid;
            }
        }

        private void HandleButtons(XK_128.XKeyEventArgs e)
        {
        ...
        private void btnFrequency_Click(object sender, EventArgs e)
        {
            ...
            xk128_1.SetFlashFrequency(0, Frequency);
        }
        ...
        private void btn1227_Click(object sender, EventArgs e)
        {
        ...
        private void btnMouse_Click(object sender, EventArgs e)
        {
            ...
            if (xk128_1.ConnectedDevices[0].MouseInterface == true)
            {
        ...
        private void btnJoystick_Click(object sender, EventArgs e)
        {
            ...
            if (xk128_1.ConnectedDevices[0].JoystickInterface == true)
            {
        ...
        private void btnCheckDongle_Click(object sender, EventArgs e)
        {
            ...
            bool dongle = xk128_1.GetSecurityKey(0, byte1, byte2, byte3, byte4);
        ...
        private void xk128_1_ButtonChange(XK_128.XKeyEventArgs e)
        {
            //This method handles the button change event for the device
            HandleButtons(e);
        }

        private void xk128_1_DevicePlug(XK_128.XKeyPlugEventArgs e)
        {
        ...
        private void xk128_1_DeviceUnplug(XK_128.XKeyPlugEventArgs e)
        {
        ...
        private void xk128_1_GenerateReportData(XK_128.XKeyEventArgs e)
        {
            HandleButtons(e);
        }
