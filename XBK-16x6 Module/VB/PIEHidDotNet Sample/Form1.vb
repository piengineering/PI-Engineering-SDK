...
Public Class Form1
        ...
        Else
            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                Else
                    ...
                    ElseIf (devices(i).Pid = 1372) Then
    ...
    Private Sub btnGetPower_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetPower.Click
        ...
        If selecteddevice <> -1 Then
            ...
            wdata(0) = 0
            wdata(1) = 146 '92H 'request power data
            ...
            Dim countout As Integer = 0
            result = devices(selecteddevice).BlockingReadData(ddata, 100)
            While (result = 304 Or (result = 0 And ddata(2) <> 146))
                If result = 304 Then
                    'no new data after 100ms, so increment countout extra
                    countout = countout + 99
                End If
            ...
            Dim currentpowerlevel As Integer = (ddata(3) * 65536) + (ddata(4) * 256) + ddata(5)
            Dim maxpowerlevel As Integer = (ddata(7) * 65536) + (ddata(4) * 256) + ddata(9)
            Dim dimfactorbank1 As Integer = ddata(10)
            Dim dimfactorbank2 As Integer = ddata(11)

            listBox4.Items.Clear()
            listBox4.Items.Add("Current Power=" + currentpowerlevel.ToString)
            listBox4.Items.Add("Maximum Power=" + maxpowerlevel.ToString)
            listBox4.Items.Add("Bank 1 Dim Factor=" + dimfactorbank1.ToString)
            listBox4.Items.Add("Bank 2 Dim Factor=" + dimfactorbank2.ToString)
