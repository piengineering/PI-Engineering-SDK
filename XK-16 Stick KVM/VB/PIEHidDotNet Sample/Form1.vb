...
Public Class Form1
            ...
            For i As Integer = 0 To maxcols - 1
                For j As Integer = 0 To maxrows - 1
                    ...
                    If state = 1 Then
                        ...
                        Me.SetText(sticklabels(keynum) & " dn")
                    ElseIf state = 3 Then
                        c = Me.buttonlabels(keynum)
                        Me.SetText(sticklabels(keynum) & " up")
                    End If
    ...
    Private Sub BtnEnumerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEnumerate.Click
        ...
        Else
            ...
            For i As Integer = 0 To devices.Length - 1
                If devices(i).HidUsagePage = 12 And devices(i).WriteLength = 36 Then
                    Select Case devices(i).Pid
                        Case 1269
                            ...
                            CboDevices.Items.Add("XK-16 Stick KVM (" + devices(i).Pid.ToString + "=PID #1)")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                            EnableAllControls()
                        Case Else
                            CboDevices.Items.Add("Unknown Device: " + devices(i).ProductString + " (" + devices(i).Pid.ToString + ")")
                            cbotodevice(cbocount) = i
                            cbocount = cbocount + 1
                    End Select
                ...
                Else
                    If (devices(i).Pid = 1270) Then
                        'Device 2 Keyboard only endpoint
                        CboDevices.Items.Add("XK-16 Stick KVM (" + devices(i).Pid.ToString + "=PID #2 - no reading or writing available, change to PID #1 by sliding program switch up and replugging device.)")
                        cbotodevice(cbocount) = i
                        cbocount = cbocount + 1
                        DisableAllControls()
    ...
    Private Sub BtnJoyreflect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub BtnDescriptor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDescriptor.Click
        If selecteddevice <> -1 Then
            ...
            Dim temp As String = ""
            temp = "PID=" + (ddata(13) * 256 + ddata(12)).ToString
