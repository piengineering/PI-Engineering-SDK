...
//	BYTE buffer[80];  //this globally declared only to keep track of LEDs	
    ...
    case WM_COMMAND:
		...
		case IDC_CHECK5:
			...
			buffer[1]=179; //0xb3
			buffer[2]=0; //6=green, 7=red, 0=out1, 1=out2
			//get checked state
	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1244)
				{
					AddDevices(hDialog, "Found Device: HD15 Wire Interface, PID=1244 (PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1245)
				{
					AddDevices(hDialog, "Found Device: HD15 Wire Interface, PID=1245 (PID #2)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1246)
				{
					AddDevices(hDialog, "Found Device: HD15 Wire Interface, PID=1246 (PID #3)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1247)
				{
					AddDevices(hDialog, "Found Device: HD15 Wire Interface, PID=1247 (PID #4)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1169)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-8, PID=1169 (PID #1)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1170)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-8, PID=1170 (PID #2)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1171)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-8, PID=1171 (PID #3)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1172)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-8, PID=1172 (PID #4)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1145)
				{
					AddDevices(hDialog, "Found Device: X-keys STG-10, PID=1145 (PID #1)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1146)
				{
					AddDevices(hDialog, "Found Device: X-keys STG-10, PID=1146 (PID #2)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1147)
				{
					AddDevices(hDialog, "Found Device: X-keys STG-10, PID=1147 (PID #3)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1148)
				{
					AddDevices(hDialog, "Found Device: X-keys STG-10, PID=1148 (PID #4)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1153)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-6, PID=1153 (PID #1)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1154)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-6, PID=1154 (PID #2)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1155)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-6, PID=1155 (PID #3)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1156)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-6, PID=1156 (PID #4)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1157)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-4, PID=1157 (PID #1)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1158)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-4, PID=1158 (PID #2)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1159)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-4, PID=1159 (PID #3)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1160)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-4, PID=1160 (PID #4)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1161)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-2, PID=1161 (PID #1)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1162)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-2, PID=1162 (PID #2)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1163)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-2, PID=1163 (PID #3)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1164)
				{
					AddDevices(hDialog, "Found Device: X-keys XKIP-2, PID=1164 (PID #4)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1184)
				{
					AddDevices(hDialog, "Found Device: X-keys PT5-10, PID=1184 (PID #1)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1185)
				{
					AddDevices(hDialog, "Found Device: X-keys PT5-10, PID=1185 (PID #2)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1186)
				{
					AddDevices(hDialog, "Found Device: X-keys PT5-10, PID=1186 (PID #3)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else if (pid==1187)
				{
					AddDevices(hDialog, "Found Device: X-keys PT5-10, PID=1187 (PID #4)");
					combotodevice[cbocount] = i;
					cbocount++;
				}
				else
