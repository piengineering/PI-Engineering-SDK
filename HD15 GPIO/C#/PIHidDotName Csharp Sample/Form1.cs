...
namespace PIHidDotName_Csharp_Sample
{
    public partial class Form1 : Form, PIEDataHandler, PIEErrorHandler
    {
            ...
            else
            {
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    if (devices[i].HidUsagePage == 0xc)// && devices[i].WriteLength==36)
                    {
                        ...
                        {
                            case 1351:
                                CboDevices.Items.Add("HD15 GPIO(" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1352:
                                CboDevices.Items.Add("HD15 GPIO(" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1353:
                                CboDevices.Items.Add("HD15 GPIO(" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1354:
                                CboDevices.Items.Add("HD15 GPIO(" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
        ...
        private void BtnDescriptor_Click(object sender, EventArgs e)
        {
            ...
            {
                //IMPORTANT turn off the callback if going so data isn't grabbed there, alternatively the returned data could be dealt with in the HandlePIEHidData
                ...
                listBox2.Items.Add("Size of Eeprom LSB=" + data[6].ToString());
                listBox2.Items.Add("Size of Eeprom MSB=" + data[7].ToString());
                int sizeofEEPROM = 256 * data[7] + data[6];
                listBox2.Items.Add("Size of Eeprom=" + sizeofEEPROM.ToString());
        ...
        private void btnSetInOut_Click(object sender, EventArgs e)
        {
            if (selecteddevice != -1) //do nothing if not enumerated
            {
                ...
                byte inputconfig1 = 0; //0=resistive pull up (short to ground), 1=resistive pull down (drive high) for pins 1-4
                byte inputconfig2 = 0; //0=resistive pull up (short to ground), 1=resistive pull down (drive high) for pins 5-12
                
                if (rb1O.Checked == true) config1 = (byte)(config1 & ~1);
                else
                {
                    if (rb1I.Checked == true) { inputconfig1 = (byte)(inputconfig1 | 1); }
                }
                if (rb2O.Checked == true) config1 = (byte)(config1 & ~2);
                else
                {
                    if (rb2I.Checked == true) { inputconfig1 = (byte)(inputconfig1 | 2); }
                }
                if (rb3O.Checked == true) config1 = (byte)(config1 & ~4);
                else
                {
                    if (rb3I.Checked == true) { inputconfig1 = (byte)(inputconfig1 | 4); }
                }
                if (rb4O.Checked == true) config1 = (byte)(config1 & ~8);
                else
                {
                    if (rb4I.Checked == true) { inputconfig1 = (byte)(inputconfig1 | 8); }
                }

                if (rb5O.Checked == true) config2 = (byte)(config2 & ~1);
                else
                {
                    if (rb5I.Checked == true) { inputconfig2 = (byte)(inputconfig2 | 1); }
                }
                if (rb6O.Checked == true) config2 = (byte)(config2 & ~2);
                else
                {
                    if (rb6I.Checked == true) { inputconfig2 = (byte)(inputconfig2 | 2); }
                }
                if (rb7O.Checked == true) config2 = (byte)(config2 & ~4);
                else
                {
                    if (rb7I.Checked == true) { inputconfig2 = (byte)(inputconfig2 | 4); }
                }
                if (rb8O.Checked == true) config2 = (byte)(config2 & ~8);
                else
                {
                    if (rb8I.Checked == true) { inputconfig2 = (byte)(inputconfig2 | 8); }
                }
                if (rb11O.Checked == true) config2 = (byte)(config2 & ~16);
                else
                {
                    if (rb11I.Checked == true) { inputconfig2 = (byte)(inputconfig2 | 16); }
                }
                if (rb12O.Checked == true) config2 = (byte)(config2 & ~32);
                else
                {
                    if (rb12I.Checked == true) { inputconfig2 = (byte)(inputconfig2 | 32); }
                }
                ...
                //this sample sets everything to output
                wData[0] = 0;
                wData[1] = 160; //A0
                ...
                {
                    toolStripStatusLabel1.Text = "Write Success - Set GPIO";
                }
            }
        }
        ...
        private void btnSaveInOut_Click(object sender, EventArgs e)
        {
            if (selecteddevice != -1) //do nothing if not enumerated
            {
                ...
                {
                    toolStripStatusLabel1.Text = "Write Success - Save GPIO";
                }
            }
        }

        private void btnGetInOut_Click(object sender, EventArgs e)
        {
            //Sending the command will make the device return information about it
            if (CboDevices.SelectedIndex != -1 && devices[selecteddevice].ReadLength > 0)
            {
                ...
                {
                    toolStripStatusLabel1.Text = "Write Success-Read GPIO configuration";
                }
                ...
                data[1] = 0;
                int ret = devices[selecteddevice].BlockingReadData(ref data, 100);
                while ((ret == 0 && data[2] != 161) || ret == 304)
                {
                    if (ret == 304)
                    {
                        // Didn't get any data for 100ms, increment the countout extra
                ...
                //data[6] gives Pins 1, 2, 3, 4 input(=1) or output(=0), data[8] gives Pins 1, 2, 3, 4 where 0=resistive pull up (short to ground), 1=resistive pull down (drive high)
                string thispin = "";
                byte val2 = (byte)(data[6] & 1);
                byte val3 = (byte)(data[8] & 1); 
                if (val2 == 0)
                {
                    thispin = "1 = Output";
                    rb1O.Checked = true;
                ...
                listBox3.Items.Add(thispin);
                //data[7] gives Pins 5, 6, 7, 8, 11, 12 input or output, data[9] gives Pins 5, 6, 7, 8, 11, 12 where 0=resistive pull up (short to ground), 1=resistive pull down (drive high)
                val2 = (byte)(data[7] & 1);
                val3 = (byte)(data[9] & 1); 
                if (val2 == 0)
                {
        ...
        private void btnGetStates_Click(object sender, EventArgs e)
        {
            ...
            if (CboDevices.SelectedIndex != -1 && devices[selecteddevice].ReadLength > 0)
            {
                ...
                wData[0] = 0;
                wData[1] = 174; //0xae return the state of the outputs
                int result = 404;
                ...
                {
                    toolStripStatusLabel1.Text = "Write Success-Read GPIO states";
                }
                ...
                data[1] = 0;
                int ret = devices[selecteddevice].BlockingReadData(ref data, 100);
                while ((ret == 0 && data[2] != 174) || ret == 304)
                {
                    if (ret == 304)
                    {
                        // Didn't get any data for 100ms, increment the countout extra
                ...
                listBox4.Items.Add(thispin);
                val2 = (byte)(data[5] & 128);
                if (val2 == 0)
                {
                    thispin = "R = off"; //Red LED
                }
                else
                {
                    thispin = "R = on";
                ...
                wData[0] = 0;
                wData[1] = 175; //0xaf return the flash state of the outputs
                result = 404;
                ...
                {
                    toolStripStatusLabel1.Text = "Write Success-Read GPIO flash states";
                }
                ...
                data[1] = 0;
                ret = devices[selecteddevice].BlockingReadData(ref data, 100);
                while ((ret == 0 && data[2] != 175) || ret == 304)
                {
                    if (ret == 304)
                    {
                        // Didn't get any data for 100ms, increment the countout extra
