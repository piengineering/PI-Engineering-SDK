	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1196)
				{
					AddDevices(hDialog, "Found Device: X-keys Matrix Encoder Board Android, PID=1196 (PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1197)
				{
					AddDevices(hDialog, "Found Device: X-keys Matrix Encoder Board Android, PID=1197 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1198)
				{
					AddDevices(hDialog, "Found Device: X-keys Matrix Encoder Board Android, PID=1198 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1199)
				{
					AddDevices(hDialog, "Found Device: X-keys Matrix Encoder Board Android, PID=1199 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1200)
				{
					AddDevices(hDialog, "Found Device: X-keys XK-3 Foot Pedal Android, PID=1200(PID #1)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1201)
				{
					AddDevices(hDialog, "Found Device: X-keys XK-3 Foot Pedal Android, PID=1201 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1202)
				{
					AddDevices(hDialog, "Found Device: X-keys XK-3 Foot Pedal Android, PID=1202 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else if (pid==1203)
				{
					AddDevices(hDialog, "Found Device: X-keys XK-3 Foot Pedal Android, PID=1203 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
				}
				else
