...
Public Class Form1
    ...
    Public Sub HandlePIEHidData(ByVal data() As Byte, ByVal sourceDevice As PIEHid32Net.PIEDevice, ByVal perror As Integer) Implements PIEHid32Net.PIEDataHandler.HandlePIEHidData
        ...
        If sourceDevice.Pid = devices(selecteddevice).Pid Then
            ...
            If (data(2) < 4) Then 'General Incoming Data
                ...
                Dim maxrows As Integer = 2 'constant, 8 bits per byte
                c = LblButtons
                ...
                For i As Integer = 0 To maxcols - 1 'loop through digital button bytes 
                    For j As Integer = 0 To maxrows - 1 'loop through each bit in the button byte
                        ...
                        Dim keynum As Integer = maxrows * i + j 'using this numbering keys are 0, 1, 2, 3, 4, 5, (6 and 7 unused) for column 1. (8, 9, 10, 11 unused), 12, 13 for column 2. 16, 17, 18, 19, 20, 21, (22 and 23 unused) for column 3.
                ...
                val2 = CByte(data(3) And 4)
                If val2 = 0 Then
                    c = Me.LblJoystickButton
                    Me.SetText("Joystick Button: off")
                Else
                    c = Me.LblJoystickButton
                    Me.SetText("Joystick Button: on")
                End If
                ...
                'Joystick X, Y, Z
                c = Me.LblJoystickX
                Me.SetText("X: " + (data(9).ToString()))
                c = Me.LblJoystickY
                Me.SetText("Y: " + (data(10).ToString()))
                c = Me.LblJoystickZ
                Me.SetText("Z: " + (data(11).ToString()))
                ...
                'Virtual Button are in data(7)
                maxcols = 1 '1 byte of virtual buttons
                maxrows = 8 'number of rows of Xkeys digital button data (8 bits per byte)
                Dim virtualbuttonsbyteoffset = 7 'virtual buttons are in data(7)
                c = Me.lblVirtualButtons
                buttonsdown = "Virtual Buttons: " 'for demonstration, reset this every time a new input report received
                Me.SetText(buttonsdown)
                For i As Integer = 0 To maxcols - 1 'loop through digital button bytes 
                    For j As Integer = 0 To maxrows - 1 'loop through each bit in the button byte
                        Dim temp1 As Integer = CInt(Math.Pow(2, j)) '1, 2, 4, 8, 16, 32, 64, 128
                        Dim thisrow As Integer = j 'bit in byte 0, 1, 2, 3, 4, 5, 6, 7
                        Dim temp2 As Byte = CByte((data(i + virtualbuttonsbyteoffset) And temp1)) 'check using bitwise AND the current value of this bit.
                        Dim temp3 As Byte = CByte((lastdata(i + virtualbuttonsbyteoffset) And temp1)) 'check using bitwise AND the previous value of this bit
                        Dim state As Integer = 0 '0=was up, now up, 1=was up, now down, 2= was down, still down, 3= was down, now up
                        If temp2 <> 0 AndAlso temp3 = 0 Then
                            state = 1 'key was up and now is down
                        ElseIf temp2 <> 0 AndAlso temp3 <> 0 Then
        ...
        Else
            ...
            For i As Integer = 0 To devices.Length - 1
                ...
                Else
                    ...
                    ElseIf (devices(i).Pid = 1613) Then
    ...
    Private Sub ChkBLOnOff_CheckStateChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkBLOnOff.CheckStateChanged
        ...
        If selecteddevice <> -1 Then
            ...
            Else
                ...
                iindex = Convert.ToInt16(sindex) + 6
            End If
    ...
    Private Sub btnDescriptor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDescriptor.Click
        If selecteddevice <> -1 Then
            ...
            listBox2.Items.Add("caldatx win=" + ddata(27).ToString())
            listBox2.Items.Add("caldaty win=" + ddata(28).ToString())
            listBox2.Items.Add("caldatz win=" + ddata(29).ToString())
            listBox2.Items.Add("caldatx end=" + ddata(30).ToString())
            listBox2.Items.Add("caldaty end=" + ddata(31).ToString())
            listBox2.Items.Add("caldatz end=" + ddata(32).ToString())
            listBox2.Items.Add("game controller enabled=" + ddata(33).ToString())
            listBox2.Items.Add("z axis or z rotation=" + ddata(34).ToString())
            listBox2.Items.Add("unit rotation=" + ddata(22).ToString())
    ...
    Private Sub btnStartCal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub btnStopCal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub btnTbarStandard_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub btnTbarInvert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnStopCalX_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStopCalX.Click
        If selecteddevice <> -1 Then
            For i As Integer = 0 To devices(selecteddevice).WriteLength - 1
                wdata(i) = 0
            Next
            ...
            wdata(0) = 0
            wdata(1) = 172 '&HAC
            wdata(2) = 0 '0=stop x, 1=start x, 2=stop y, 3=start y, 4=stop z, 5=start z
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Stop Cal X"
            End If

        End If
    End Sub

    Private Sub btnStartCalX_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartCalX.Click
        If selecteddevice <> -1 Then
            For i As Integer = 0 To devices(selecteddevice).WriteLength - 1
                wdata(i) = 0
            Next
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Start Cal X"
            End If

        End If
    End Sub

    Private Sub btnStartCalY_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartCalY.Click
        If selecteddevice <> -1 Then
            For i As Integer = 0 To devices(selecteddevice).WriteLength - 1
                wdata(i) = 0
            Next
            ...
            wdata(0) = 0
            wdata(1) = 172 '&HAC
            wdata(2) = 3 '0=stop x, 1=start x, 2=stop y, 3=start y, 4=stop z, 5=start z
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Start Cal Y"
            End If

        End If
    End Sub

    Private Sub btnStopCalY_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStopCalY.Click
        If selecteddevice <> -1 Then
            For i As Integer = 0 To devices(selecteddevice).WriteLength - 1
                wdata(i) = 0
            Next
            ...
            wdata(0) = 0
            wdata(1) = 172 '&HAC
            wdata(2) = 2 '0=stop x, 1=start x, 2=stop y, 3=start y, 4=stop z, 5=start z
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Stop Cal Y"
            End If

        End If
    End Sub

    Private Sub btnStartCalZ_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartCalZ.Click
        If selecteddevice <> -1 Then
            For i As Integer = 0 To devices(selecteddevice).WriteLength - 1
                wdata(i) = 0
            Next
            ...
            wdata(0) = 0
            wdata(1) = 172 '&HAC
            wdata(2) = 5 '0=stop x, 1=start x, 2=stop y, 3=start y, 4=stop z, 5=start z
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Start Cal Z"
            End If

        End If
    End Sub

    Private Sub btnStopCalZ_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStopCalZ.Click
        If selecteddevice <> -1 Then
            For i As Integer = 0 To devices(selecteddevice).WriteLength - 1
                wdata(i) = 0
            Next
            ...
            wdata(0) = 0
            wdata(1) = 172 '&HAC
            wdata(2) = 4 '0=stop x, 1=start x, 2=stop y, 3=start y, 4=stop z, 5=start z
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Stop Cal Z"
            End If

        End If
    End Sub

    Private Sub btnRotateUnit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRotateUnit.Click
        ...
        If selecteddevice <> -1 Then
            ...
            wdata(1) = 151 '&H97
            wdata(2) = CByte(cboUnitRotation.SelectedIndex) '0=0deg (button top, joystick bottom), 1=90deg (joystick on right, buttons on left), 2=180deg (joystick top, buttons bottom), 3=270deg (joystick on left, buttons on right)
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Unit Orientation"
            End If
        End If
    End Sub

    Private Sub btnDisableGameController_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDisableGameController.Click
        ...
        If selecteddevice <> -1 Then
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Disable Game Controller Messages from Joystick"
            End If
        End If
    End Sub

    Private Sub btnEnableGameController_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnableGameController.Click
        ...
        If selecteddevice <> -1 Then
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Enable Game Controller Messages from Joystick"
            End If
        End If
    End Sub

    Private Sub btnZaxis_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnZaxis.Click
        ...
        If selecteddevice <> -1 Then
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Joystick twist sends Z Axis"
            End If
        End If
    End Sub

    Private Sub btnZrot_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnZrot.Click
        'Sending this command will cause the joystick twist motion to send game controller Z Rotation messages if game controller is enabled
        If selecteddevice <> -1 Then
            ...
            If result <> 0 Then
                lblStatus.Text = "Write Fail: " + result.ToString
            Else
                lblStatus.Text = "Write Success - Joystick twist sends Z Rotation"
            End If
        End If
    End Sub
End Class
