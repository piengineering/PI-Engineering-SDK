...
Public Class Form1
    ...
    Private Sub DisableAllControls(ByVal thispid As Integer)
        ...
        If thispid = 1403 Then
            MessageBox.Show("Device in PID #8 (KVM), no input or output reports are available. To exit KVM mode unplug device and replug it, immediately toggle the Scroll Lock key several times.")
