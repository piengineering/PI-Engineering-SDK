	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				if (pid==1355)
				{
					AddDevices(hDialog, "Found Device: XKE-40, PID=1355 (PID #1)");
				...
				{
					AddDevices(hDialog, "Found Device: XKE-40, PID=1356 (PID #2)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
					pidlist=1;
				}
				...
				{
					AddDevices(hDialog, "Found Device: XKE-40, PID=1357 (PID #3)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
					pidlist=2;
				}
				...
				{
					AddDevices(hDialog, "Found Device: XKE-40, PID=1358 (PID #4)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
					pidlist=3;
				}
				...
				{
					AddDevices(hDialog, "Found Device: XKE-40, PID=1359 (PID #5)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
					pidlist=4;
				}
				...
				{
					AddDevices(hDialog, "Found Device: XKE-40, PID=1360 (PID #6)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
					pidlist=5;
				}
				...
				{
					AddDevices(hDialog, "Found Device: XKE-40, PID=1361 (PID #7)");
					combotodevice[cbocount] = i; //this is the handle
					cbocount++;
					pidlist=6;
				}
		...
		else
		{
			if (pid==1362)
			{
				AddDevices(hDialog, "Found Device: X-keys XKE-40, PID=1362 or PID #8 (KVM).");
